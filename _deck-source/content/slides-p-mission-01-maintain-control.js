...
module.exports = {
  ...
  <rect x="20" y="16" width="720" height="46" rx="8" fill="#EDF1F3" stroke="#0B1530" stroke-width="1.5"/>
  <text x="380" y="45" text-anchor="middle" font-family="system-ui,sans-serif" font-size="17" font-weight="700" fill="#0B1530">Total body water</text>
  <line x1="380" y1="62" x2="380" y2="80" stroke="#0B1530" stroke-width="1.5"/>
  <line x1="200" y1="80" x2="560" y2="80" stroke="#0B1530" stroke-width="1.5"/>
  <line x1="200" y1="80" x2="200" y2="98" stroke="#0B1530" stroke-width="1.5"/>
  <line x1="560" y1="80" x2="560" y2="98" stroke="#0B1530" stroke-width="1.5"/>
  ...
  <rect x="420" y="98" width="280" height="70" rx="8" fill="#FFFFFF" stroke="#8B3A2E" stroke-width="2" stroke-dasharray="6 4"/>
  <text x="560" y="126" text-anchor="middle" font-family="system-ui,sans-serif" font-size="15" font-weight="700" fill="#8B3A2E">Extracellular fluid</text>
  <text x="560" y="149" text-anchor="middle" font-family="system-ui,sans-serif" font-size="13" fill="#3D4860">about one third</text>
  <line x1="560" y1="168" x2="560" y2="188" stroke="#8B3A2E" stroke-width="1.5"/>
  <line x1="470" y1="188" x2="650" y2="188" stroke="#8B3A2E" stroke-width="1.5"/>
  <line x1="470" y1="188" x2="470" y2="206" stroke="#8B3A2E" stroke-width="1.5"/>
  <line x1="650" y1="188" x2="650" y2="206" stroke="#8B3A2E" stroke-width="1.5"/>
  <rect x="380" y="206" width="180" height="62" rx="8" fill="#FFFFFF" stroke="#8B3A2E" stroke-width="1.5" stroke-dasharray="6 4"/>
  <text x="470" y="232" text-anchor="middle" font-family="system-ui,sans-serif" font-size="14" font-weight="700" fill="#8B3A2E">Interstitial fluid</text>
  <text x="470" y="253" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12.5" fill="#3D4860">bathes the cells</text>
  <rect x="580" y="206" width="140" height="62" rx="8" fill="#FFFFFF" stroke="#8B3A2E" stroke-width="1.5" stroke-dasharray="6 4"/>
  <text x="650" y="232" text-anchor="middle" font-family="system-ui,sans-serif" font-size="14" font-weight="700" fill="#8B3A2E">Plasma</text>
  ...
  <defs>
    <marker id="ar" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0 0 L10 5 L0 10 z" fill="#0B1530"/></marker>
    <marker id="arg" viewBox="0 0 10 10" refX="9" refY="5" markerWidth="7" markerHeight="7" orient="auto"><path d="M0 0 L10 5 L0 10 z" fill="#C9A14A"/></marker>
  </defs>
  <rect x="250" y="10" width="260" height="46" rx="8" fill="#EDF1F3" stroke="#0B1530" stroke-width="2"/>
  <text x="380" y="32" text-anchor="middle" font-family="system-ui,sans-serif" font-size="14" font-weight="700" fill="#0B1530">Regulated variable</text>
  <text x="380" y="49" text-anchor="middle" font-family="system-ui,sans-serif" font-size="12.5" fill="#3D4860">moves off setpoint</text>
  <line x1="380" y1="56" x2="380" y2="76" stroke="#0B1530" stroke-width="2" marker-end="url(#ar)"/>
  ...
  <line x1="380" y1="122" x2="380" y2="146" stroke="#0B1530" stroke-width="2" marker-end="url(#ar)"/>
  <text x="392" y="139" font-family="system-ui,sans-serif" font-size="12" font-weight="700" fill="#8B3A2E">2. afferent pathway</text>
  <rect x="250" y="150" width="260" height="60" rx="8" fill="#FFFFFF" stroke="#8B3A2E" stroke-width="2"/>
  <text x="380" y="172" text-anchor="middle" font-family="system-ui,sans-serif" font-size="14" font-weight="700" fill="#8B3A2E">3. Integrating center</text>
  ...
  <line x1="380" y1="210" x2="380" y2="234" stroke="#0B1530" stroke-width="2" marker-end="url(#ar)"/>
  <text x="392" y="227" font-family="system-ui,sans-serif" font-size="12" font-weight="700" fill="#8B3A2E">4. efferent pathway</text>
  ...
  <path d="M270 259 L120 259 L120 33 L250 33" fill="none" stroke="#C9A14A" stroke-width="2.5" marker-end="url(#arg)"/>
